...
export const _permissions = [
  {
    ...
    User: {Read: false, List: false, Add: true, Edit: false, Delete: false},
    Viewer: {Read: true, List: true, Add: true, Edit: false, Delete: false},
    Guest: {Read: false, List: false, Add: false, Edit: false, Delete: false},
  },
  {
    listname: 'User',
    Manager: {Read: true, List: true, Add: true, Edit: false, Delete: false},
    User: {Read: false, List: false, Add: true, Edit: false, Delete: false},
    Viewer: {Read: false, List: false, Add: true, Edit: false, Delete: false},
    Guest: {Add: true},
  },
  {
  ...
  {
    listname: 'Verify',
    Manager: {Read: false, List: false, Add: false, Edit: false, Delete: false},
    User: {Read: false, List: false, Add: false, Edit: false, Delete: false},
    Viewer: {Read: false, List: false, Add: false, Edit: false, Delete: false},
    Guest: {Read: true},
  },
  {
    listname: 'Counter',
  ...
  },
  {
    ...
    Viewer: {Read: true, List: true, Add: false, Edit: false, Delete: false},
    Guest: {Read: true, List: true, Add: false},
  },
  {
    listname: 'Category',
    Manager: {Read: true, List: true, Add: true, Edit: true, Delete: false},
